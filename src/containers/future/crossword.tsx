...
const downQuestions: Question[] = [
  {
    ...
    codeSnippet: `const text = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam condimentum viverra libero, non vehicula magna dignissim eget. Duis eleifend consectetur tortor ac interdum. Donec sem sapien, cursus nec lectus a, semper tempus purus. Aliquam sit amet augue lobortis, viverra metus ac, fringilla ante. Aliquam neque nisi, ultrices quis risus at, porta iaculis odio. Aliquam lectus tellus, tempus eu nulla sed, tincidunt venenatis sapien. Sed varius enim sed massa maximus efficitur. Sed in diam ut augue pharetra faucibus eu sed ex. Morbi vel augue ac justo auctor condimentum quis eu elit. Ut efficitur tincidunt sodales. Aenean at velit eu justo facilisis euismod. Etiam eleifend elementum ante at aliquet.';`,
    hint: 'Hint: (5,6)',
  },
  {
    question: `Why does one of the O(n^3) methods significantly outperform the others in matrix multiplication, including the Strassen Matrix Multiplication Algorithm with a complexity of O(n lg 7), especially when the input size is 1024, despite their near-identical nature? and which one is faster?
